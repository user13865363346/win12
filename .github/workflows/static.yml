...
-->
	...
	<div id="start-menu">
		...
		<div id="s-m-l">
			...
			<list>
				...
				<a oncontextmenu="return showcm(event, 'smlapp', ['guess.txt', '猜一猜.txt'])" onclick="openapp('guess.txt');hide_startmenu();">
					<img src="icon/folder/docs.svg">
					<p data-i18n="guess.name">猜一猜.txt</p>
				</a>
		...
		<div id="s-m-r">
			<div class="row1">
				...
				<div class="tool">
					...
					<p class="date">星期八, 9191年91月91日</p>
					<div class="pw">
	...
	<div id="search-win">
		<!-- 搜索框 -->
		<input type="text" class="input" placeholder="在这里输入你要搜索的内容(当然,没什么卵用......)" id="search-input"
	...
	<div id="widgets">
		...
		<div class="news">
			<div class="bar">
				...
				<div>
					<span style="color: #7f7f7f;margin-right: 5px;margin-top: 2px;" data-i18n="widget-news-res">我们不对新闻内容负责o(嗯,你看个迪奥啊!)</span>
								...
								<div class="card4">
									...
									<div class="right">
										<div class="tit">
											<div class="up">
												<div 
class="name" data-i18n="msstore.mc">斐济被</div>
												<div class="type" data-i18n="msstore.free">9.9￥包邮到家!</div>
											</div>
											<div class="down">
												<div class="rating"></div>
												<div class="cate" data-i18n="msstore.game">游戏</div>
		...
		<div class="content" id="win-setting">
			<div class="menu">
				<a class="a user">
					...
					<div>
						<p data-i18n="setting.usrname">帅逼-->吴yx</p>
